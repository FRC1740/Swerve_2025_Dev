...
public class MAXSwerveModule {
  ...
  private final SparkBase m_turningSparkMax;
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    ...
    SparkMaxConfig m_drivingSparkMaxConfig = new SparkMaxConfig();
    SparkMaxConfig m_turningSparkMaxConfig = new SparkMaxConfig();
    ...
    m_drivingSparkMaxConfig.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder);
    m_turningSparkMaxConfig.closedLoop.feedbackSensor(FeedbackSensor.kAbsoluteEncoder);
    ...
    m_drivingSparkMaxConfig.encoder
    ...
    m_turningSparkMaxConfig.encoder
    ...
    ArbFFUnits arbFFUnits = ArbFFUnits.fromInt(0);
    ControlType ctrl = ControlType.kPosition;
    m_turningPIDController.setReference(turningCANId, ctrl, slot, chassisAngularOffset, arbFFUnits);
